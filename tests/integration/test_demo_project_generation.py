...
def test_project_generate_creates_doc_in_demo(tmp_path):
    # Use the demo project created under the repository but copy to tmp to avoid modifying tracked files
    ...
    doc_file = (
        demo_project / "docs" / "ansibleproject_project-demo-namespace-demo-project" / "README.md"
    )
