...
class TestConfigModelValidation:
    ...
    def test_config_model_extra_fields_forbidden(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            ConfigModel(
                output_format="html", unknown_field="invalid", another_unknown="also_invalid"
            )
    ...
    def test_config_model_whitespace_stripping(self):
        ...
        config = ConfigModel(
            output="  docs/role.html  ", output_format="  html  ", template="  template.j2  "
        )
    ...
    def test_config_model_none_values_accepted(self):
        ...
        config = ConfigModel(
            output=None, output_format=None, template=None, template_dir=None, output_dir=None
        )
...
class TestConfigModelEdgeCases:
    ...
    def test_config_model_dict_export(self):
        ...
        config = ConfigModel(output_format="html", recursive=True, exclude_patterns=["*.pyc"])
    ...
    def test_config_model_json_serialization(self):
        ...
        config = ConfigModel(
            output_format="markdown", recursive=False, exclude_patterns=["*.pyc", "__pycache__"]
        )
    ...
    def test_config_model_from_dict(self):
        ...
        data = {"output_format": "rst", "recursive": True, "output_dir": "docs/"}
