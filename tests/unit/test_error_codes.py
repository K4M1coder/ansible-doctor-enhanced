...
class TestErrorCodeUniqueness:
    ...
    def test_error_codes_follow_hierarchy(self):
        ...
        for code_enum in ErrorCode:
            ...
            assert (
                1 <= category <= 4
            ), f"Error code {code} should be in E1xx-E4xx or W1xx-W4xx range"
    ...
    def test_error_code_enum_names_match_values(self):
        ...
        for code_enum in ErrorCode:
            ...
            assert (
                code_enum.value in code_enum.name
...
class TestIgnoreFlagSuppression:
    ...
    def test_ignore_codes_with_warnings(self):
        ...
        aggregator.add_error(
            "W102", "Missing documentation", file_path="README.md", severity="warning"
        )
        aggregator.add_error(
            "W103", "Undocumented variable", file_path="defaults/main.yml", severity="warning"
        )
