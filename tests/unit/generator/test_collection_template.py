...
class TestCollectionTemplate:
    ...
    def test_render_collection_template_with_metadata(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_template_includes_installation_instructions(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_template_includes_role_index_with_descriptions(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_template_includes_plugin_list_grouped_by_type(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_template_includes_dependencies_section(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_template_includes_examples_playbooks_section(
        self, tmp_path: Path
    ) -> None:
