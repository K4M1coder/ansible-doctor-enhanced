...
class TestPluginDiscovery:
    ...
    def test_discovers_python_modules_in_plugins_directory(
        self, tmp_path: Path
    ) -> None:
        ...
        (modules_dir / "another_module.py").write_text(
            '"""Another module."""'
        )
    ...
    def test_detects_plugin_type_from_directory_path(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_discovers_plugins_in_nested_subdirectories(
        self, tmp_path: Path
    ) -> None:
    ...
    def test_multiple_plugin_types_in_same_collection(
        self, tmp_path: Path
    ) -> None:
