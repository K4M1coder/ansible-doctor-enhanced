...
class TestAnnotationParsingProperties:
    ...
    @given(line_count=st.integers(min_value=1, max_value=20))
    ...
    @given(comment_count=st.integers(min_value=0, max_value=50))
    ...
    @given(spacing=st.integers(min_value=0, max_value=10))
